...
Procedure MasFill(var mas_: Tmas);   //Заполнение массива
var i:integer;
begin
 Randomize;
 for i:= 1 to N do
...
Procedure MasSwap(var a, b:integer);        //Свап элементов
var temp: integer;
begin
 temp:=a;
 a:=b;
...
var i, j: integer;                                     // пузырёк с флагом
    f: boolean;
begin
 comp:=0;
 swap:=0;
...
var L,R, i: integer;                                  //шейкерная сортировка
begin
  L:=2;
  R:=len;
  swap:=0;
...
begin
 ...
 writeln('|  ',leng:4,' эл.  |             |            |             |            |             |            |');
 writeln('|','неотсорт.':12,'|',compar_sk:13,'|',swap_sk:12,'|',compar_bub:13,'|',swap_bub:12,'|', compar_q:13,'|', swap_q:12, '|');
 writeln('|------------|-------------|------------|-------------|------------|-------------|------------|');
 ...
 QSort(Quick_mas, 1, leng, compar_q, swap_q);
 writeln('|  ',leng:4,' эл.  |             |            |             |            |             |            |');
 writeln('|','  отсорт.':12,'|',compar_sk:13,'|',swap_sk:12,'|',compar_bub:13,'|',swap_bub:12,'|', compar_q:13,'|', swap_q:12, '|');
 writeln('|------------|-------------|------------|-------------|------------|-------------|------------|');
 ...
 QSort(Quick_mas, 1, leng, compar_q, swap_q);
 writeln('|  ',leng:4,' эл.  |             |            |             |            |             |            |');
 writeln('|','отсорт.обр':12,'|',compar_sk:13,'|',swap_sk:12,'|',compar_bub:13,'|',swap_bub:12,'|', compar_q:13,'|', swap_q:12, '|');
 writeln('|------------|-------------|------------|-------------|------------|-------------|------------|');
end;
...
begin
 writeln('-----------------------------------------------------------------------------------------------');
 writeln('|            |   Шейкерная сортировка   |     Пузырёк с флагом     |        Quick Sort        |');
 writeln('|    Тип     |--------------------------|--------------------------|--------------------------|');
